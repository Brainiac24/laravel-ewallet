...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($accountTypeDetailRepositoryContract , ['route' => ['admin.accounts.types-detail.update', $accountTypeDetailRepositoryContract->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
