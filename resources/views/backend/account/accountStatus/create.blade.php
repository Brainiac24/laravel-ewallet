...
@section('title', trans('accountStatus.backend.title'))
...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => 'admin.accounts.status.store','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.account.accountStatus.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
