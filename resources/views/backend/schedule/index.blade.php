        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans('schedule.backend.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'cron_expression',
                        caption: '{{ trans('schedule.backend.cron_expression') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'create_by_user_id',
                        caption: '{{ trans('schedule.backend.create_by_user_id') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'schedule_type_id',
                        caption: '{{ trans('schedule.backend.schedule_type_id') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{ trans('schedule.backend.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.schedule.partials.table')
                ]
            });
