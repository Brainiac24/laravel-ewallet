    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('color.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('color.backend.table.color') }}', type: 'text' },
                ],
                columns: [
                    {
                        field: 'recid',
                        ...
                        field: 'code',
                        caption: '{{ trans('color.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'color',
                        caption: '{{ trans('color.backend.table.color') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                ...
                records: [
                    @include('backend.color.partials.table')
                ]
            });
        });
    </script>
