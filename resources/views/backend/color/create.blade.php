...
@section('title', trans('color.backend.title'))
...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => 'admin.colors.store','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.color.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
