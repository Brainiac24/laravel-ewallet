...
@section('content_header')
    <h1>{{ trans('transactionStatusDetail.backend.title') }}</h1>
@stop
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans("transactionStatusDetail.backend.table.code") }}', type: 'text' },
                    { field: 'name', caption: '{{ trans("transactionStatusDetail.backend.table.name") }}', type: 'text' },
                    { field: 'created_at', caption: '{{ trans("transactionStatusDetail.backend.table.created_at") }}', type: 'date' },
                    { field: 'updated_at', caption: '{{ trans("transactionStatusDetail.backend.table.updated_at") }}', type: 'date'}
                ],
                columns: [
                    {field: 'recid', caption: 'ID', size: '50px', sortable: true, attr: 'align=left'},
                    {
                        field: 'code',
                        caption: '{{ trans('transactionStatusDetail.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{ trans('transactionStatusDetail.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'color',
                        caption: '{{ trans('transactionStatusDetail.backend.table.color')}}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('transactionStatusDetail.backend.table.updated_at')}}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'created_at',
                        caption: '{{ trans('transactionStatusDetail.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.transaction.transactionStatusDetail.partials.table')
                ]
            });
        });
    </script>
