...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($transactionContinueRule , ['route' => ['admin.transactions.continueRules.update', $transactionContinueRule->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
