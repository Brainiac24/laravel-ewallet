...
@section('content')
    ...
    <div class="box box-solid">
        ...
        <div class="box-footer">
            {{  $coordinatePointWorkdays->render() }}
        </div>
    </div><!-- /.box -->
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                   ...
                   {
                        field: 'name',
                        caption: '{{ trans('coordinatePointWorkday.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'monday',
                        caption: '{{trans('coordinatePointWorkday.backend.table.monday') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'tuesday',
                        caption: '{{trans('coordinatePointWorkday.backend.table.tuesday') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'wednesday',
                        caption: '{{trans('coordinatePointWorkday.backend.table.wednesday') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'thursday',
                        caption: '{{trans('coordinatePointWorkday.backend.table.thursday') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        ...
                        field: 'saturday',
                        caption: '{{trans('coordinatePointWorkday.backend.table.saturday') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'sunday',
                        caption: '{{trans('coordinatePointWorkday.backend.table.sunday') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{trans('coordinatePointWorkday.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{trans('coordinatePointWorkday.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{trans('coordinatePointWorkday.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.coordinatepoint.coordinatePointWorkday.partials.table')
                ]
            });
        });
    </script>
