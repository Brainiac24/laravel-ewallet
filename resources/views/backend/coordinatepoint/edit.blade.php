...
@section('content')
    ...
    <script>
        ...
        var map = L.map('map').setView([ {{$coordinatePoint->latitude}}, {{$coordinatePoint->longitude}}], 17);
        ...
        marker2 = L.marker([ {{$coordinatePoint->latitude}}, {{$coordinatePoint->longitude}}], {icon: mainOfficeIcon , draggable:true}).bindPopup("{{$coordinatePoint->name}} ").addTo(map);
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($coordinatePoint , ['route' => ['admin.coordinatepoints.update', $coordinatePoint->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
