        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans('coordinatePointType.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'code',
                        caption: '{{ trans('coordinatePointType.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'coordinate_point_workday_id',
                        caption: '{{ trans('coordinatePointType.backend.table.coordinate_point_workday_id') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'position',
                        caption: '{{trans('coordinatePointType.backend.table.position') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_show_for_filter',
                        caption: '{{trans('coordinatePointType.backend.table.is_show_for_filter') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{trans('coordinatePointType.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{trans('coordinatePointType.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{trans('coordinatePointType.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.coordinatepoint.coordinatePointType.partials.table')
                ]
            });
        });
    </script>
