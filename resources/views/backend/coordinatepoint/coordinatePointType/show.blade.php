...
@section('content')
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            @include('backend.coordinatepoint.coordinatePointType.partials.show_fields')
        </div><!-- /.box-body -->
        <div class="box-footer">
            {!!  link_to(URL::previous(), trans('actions.general.back'), ['class' => 'btn btn-default'], $secure = null) !!}
        </div><!-- box-footer -->
    </div><!-- /.box -->
    @include('backend.coordinatepoint.coordinatePointTypeService.partials.index_table')
@stop