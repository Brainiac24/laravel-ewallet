<div class="box box-default form-horizontal @if($data==[])collapsed-box @endif">
    ...
    <div class="box-body">
        ...
        @endif
        @include('backend.coordinatepoint.partials.fields_search_box')
                              <div class="form-group">
                                    <div for="number" class="col-sm-5 control-label"></div>
                                {!! Form::submit('Поиск', ['class' => 'btn btn-primary']) !!}
                                <a type="submit" class="btn btn-danger" style="margin:0px 8px" href="{!! route('admin.coordinatepoints.index') !!}">
                                    Сбросить
                                </a>
