...
@section('content_header')
    <h1>{{ trans('coordinatePointService.backend.title') }}</h1>
@stop
...
@section('content')
    ...
    <div class="box box-solid">
        ...
        <div class="box-footer">
            {{  $coordinatePointServices->render() }}
        </div>
    </div><!-- /.box -->
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans('coordinatePointService.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'position',
                        caption: '{{trans('coordinatePointService.backend.table.position') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_show_for_filter',
                        caption: '{{trans('coordinatePointService.backend.table.is_show_for_filter') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{trans('coordinatePointService.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{trans('coordinatePointService.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{trans('coordinatePointService.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.coordinatepoint.coordinatePointService.partials.table')
                ]
            });
        });
    </script>
