...
@section('content_header')
    <h1>{{ trans('profile.backend.title') }}</h1>
@stop
...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($user , ['route' => ['admin.profile.update'], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-attestation']) !!}
            @include('backend.user.profile.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
