...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($data , ['route' => ['admin.documentTypes.update', $data->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.documentType.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
