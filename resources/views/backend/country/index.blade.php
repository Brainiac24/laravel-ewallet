...
@section('content_header')
    <h1>{{ trans('country.backend.title') }}</h1>
@stop
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('country.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('country.backend.table.name') }}', type: 'text' },
                    { field: 'desc', caption: '{{ trans('country.backend.table.desc') }}', type: 'text' },
                ...
                columns: [
                    {
                        ...
                        field: 'code',
                        caption: '{{ trans('country.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'code_map',
                        caption: '{{ trans('country.backend.table.code_map') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{ trans('country.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'desc',
                        caption: '{{ trans('country.backend.table.desc') }}',
                        size: '80%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'iso_2',
                        caption: '{{ trans('country.backend.table.iso_2') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'iso_3',
                        caption: '{{ trans('country.backend.table.iso_3') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{ trans('country.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('country.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('country.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.country.partials.table')
                ]
            });
        });
    </script>
