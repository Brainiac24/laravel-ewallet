        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans("reportAnalysis.backend.table.name") }}',
                        size: '100%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'is_active',
                        caption: '{{ trans("reportAnalysis.backend.table.is_active") }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'created_at',
                        caption: '{{ trans("reportAnalysis.backend.table.created_at") }}',
                        size: '120px',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans("reportAnalysis.backend.table.updated_at") }}',
                        size: '120px',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.reports.reportAnalysis.partials.table')
                ]
            });
