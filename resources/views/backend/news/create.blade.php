...
@section('title', trans('bank.backend.title'))
...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => 'admin.news.store','class'=>'form-horizontal','id'=>'form-category','enctype'=>"multipart/form-data"]) !!}
            @include('backend.news.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
