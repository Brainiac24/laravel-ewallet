...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($currencyRate , ['route' => ['admin.currencies.rates.update', $currencyRate->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.currency.currencyRate.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
