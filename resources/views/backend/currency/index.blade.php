    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('currency.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('currency.backend.table.code') }}', type: 'text' },
                    { field: 'short_name', caption: '{{ trans('currency.backend.table.short_name') }}', type: 'text' },
                    { field: 'iso_name', caption: '{{ trans('currency.backend.table.iso_name') }}', type: 'text' },
                ...
                columns: [
                    {field: 'recid', caption: 'ID', size: '50px', sortable: true, attr: 'align=left'},
                    {
                        ...
                        field: 'updated_at',
                        caption: '{{ trans('currency.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('currency.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.currency.partials.table')
                ]
            });
        });
    </script>
