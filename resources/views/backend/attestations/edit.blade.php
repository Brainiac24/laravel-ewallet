...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($attestation, ['route' => ['admin.attestations.update', $attestation->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-attestation']) !!}
            @include('backend.attestations.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
