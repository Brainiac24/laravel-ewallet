...
@section('content_header')
    <h1>{{ trans('attestations.backend.attestation') }}</h1>
@stop
...
@section('content')
    ...
    <div class="box box-solid">
        <style>
            .myPaddingClass {padding: 6px 12px;}
            .form-group {margin-bottom: 15px !important;}
            .control-label {padding-right: 15px !important;}
        </style>
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'code',
                        caption: '{{ trans('attestations.backend.table.code')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{trans('attestations.backend.table.name')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'day_limit',
                        caption: '{{trans('attestations.backend.table.day_limit')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'week_limit',
                        caption: '{{trans('attestations.backend.table.week_limit')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'month_limit',
                        caption: '{{trans('attestations.backend.table.month_limit')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'balance_limit',
                        caption: '{{trans('attestations.backend.table.balance')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{trans('attestations.backend.table.updated_at')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{trans('attestations.backend.table.created_at')  }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.attestations.partials.table')
                ]
            });
        });
    </script>
