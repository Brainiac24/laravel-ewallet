    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    {
                        ...
                        field: 'title',
                        caption: '{{ trans('faqQuestion.backend.table.title') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {{--{--}}
                    {{--    field: 'parent_id',--}}
                    {{--    caption: '{{ trans('faqQuestion.backend.table.parent_id') }}',--}}
                    {{--    size: '50%',--}}
                    {{--    sortable: true,--}}
                    {{--    attr: 'align=left'--}}
                    {{--},--}}
                    {
                        field: 'position',
                        caption: '{{ trans('faqQuestion.backend.table.position') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{ trans('faqQuestion.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('faqQuestion.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('faqQuestion.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.faq.faqQuestion.partials.table')
                ]
            });
        });
    </script>
