...
@section('title', trans('region.backend.title'))
...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => 'admin.areas.store','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.area.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
