    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('area.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('area.backend.table.name') }}', type: 'text' },
                    { field: 'desc', caption: '{{ trans('area.backend.table.desc') }}', type: 'text' },
                ],
                columns: [
                    {
                        field: 'recid',
                        ...
                        field: 'code',
                        caption: '{{ trans('area.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'code_map',
                        caption: '{{ trans('area.backend.table.code_map') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{ trans('area.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        ...
                        field: 'updated_at',
                        caption: '{{ trans('area.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('area.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.area.partials.table')
                ]
            });
        });
    </script>
