...
@section('content_header')
    <h1>{{ trans('merchantUser.backend.title') }}</h1>
@stop

@section('content')
    @include('backend.errors.success')
    @include('backend.errors.error')
    @include('backend.merchant.merchantUser.partials.search_box')
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    {
                        ...
                        field: 'merchant_name',
                        caption: '{{ trans('merchantUser.backend.table.merchant_name') }}',
                        size: '70%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'user_fullname',
                        caption: '{{ trans('merchantUser.backend.table.user_fullname') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'user_msisdn',
                        caption: '{{ trans('merchantUser.backend.table.user_msisdn') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'account_number',
                        caption: '{{ trans('merchantUser.backend.table.account_number') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'merchant_address',
                        caption: '{{ trans('merchantUser.backend.table.merchant_address') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'merchant_inn',
                        caption: '{{ trans('merchantUser.backend.table.merchant_inn') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'merchant_city',
                        caption: '{{ trans('merchantUser.backend.table.merchant_city') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'merchant_account_number',
                        caption: '{{ trans('merchantUser.backend.table.merchant_account_number') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_approved',
                        caption: '{{ trans('merchantUser.backend.table.is_approved') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{ trans('merchantUser.backend.table.is_active') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('merchantUser.backend.table.created_at') }}',
                        size: '35%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('merchantUser.backend.table.updated_at') }}',
                        size: '35%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.merchant.merchantUser.partials.table')
                ]
            });
        });
    </script>
