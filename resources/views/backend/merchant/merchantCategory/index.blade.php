...
@section('content_header')
    <h1>{{ trans('merchantCategory.backend.title') }}</h1>
@stop
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    {field: 'name', caption: '{{ trans('merchantCategory.backend.table.name') }}', type: 'text'}
                ],
                columns: [
                    {
                        field: 'recid',
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans('merchantCategory.backend.table.name') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'is_active',
                        caption: '{{ trans('merchantCategory.backend.table.is_active') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'updated_at',
                        caption: '{{ trans('merchantCategory.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'created_at',
                        caption: '{{ trans('merchantCategory.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.merchant.merchantCategory.partials.table')
                ]
            });
        });
    </script>
