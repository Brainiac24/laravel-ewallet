...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($data , ['route' => ['admin.merchants.commissions.update', $data->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.merchant.merchantCommission.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
