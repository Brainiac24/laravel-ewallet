<div class="form-group">
    {!! Form::label('id', trans('merchantCommission.backend.id'), ['class' => 'col-sm-5 control-label']) !!}
    <div class="col-sm-3">
        {!! Form::text('id', null, ['class'=>'form-control']) !!}
    </div>
</div>
<div class="form-group">
    {!! Form::label('name', trans('merchantCommissionItem.backend.name'), ['class' => 'col-sm-5 control-label']) !!}
    <div class="col-sm-3">
