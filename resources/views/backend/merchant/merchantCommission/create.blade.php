...
@section('title', trans('merchantCommission.backend.title'))
...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => 'admin.merchants.commissions.store','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.merchant.merchantCommission.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
