...
@section('content')
    ...
    @include('backend.merchant.merchantItem.partials.search_box')
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'merchant_id',
                        caption: '{{ trans('merchantItem.backend.table.merchant_id') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {{--{--}}
                        {{--field: 'account_id',--}}
                        {{--caption: '{{ trans('merchantItem.backend.table.account_id') }}',--}}
                        {{--size: '25%',--}}
                        {{--sortable: true,--}}
                        {{--attr: 'align=left'--}}
                    {{--},--}}
