...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => ['admin.merchants.items.store',$merchant_id,null],'class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.merchant.merchantItem.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
