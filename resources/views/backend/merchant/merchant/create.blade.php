...
@section('content')
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => 'admin.merchants.store','class'=>'form-horizontal','id'=>'form-category','enctype'=>"multipart/form-data"]) !!}
            @include('backend.merchant.merchant.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
