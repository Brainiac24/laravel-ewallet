...
@section('content_header')
    <h1>{{ trans('merchantWorkdays.backend.title') }}</h1>
@stop
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    {field: 'name', caption: '{{ trans('merchantWorkdays.backend.table.name') }}', type: 'text'}
                ],
                columns: [
                    {
                        field: 'recid',
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans('merchantWorkdays.backend.table.name') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'monday',
                        caption: '{{ trans('merchantWorkdays.backend.table.monday') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'tuesday',
                        caption: '{{ trans('merchantWorkdays.backend.table.tuesday') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'wednesday',
                        caption: '{{ trans('merchantWorkdays.backend.table.wednesday') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'thursday',
                        caption: '{{ trans('merchantWorkdays.backend.table.thursday') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'friday',
                        caption: '{{ trans('merchantWorkdays.backend.table.friday') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'saturday',
                        caption: '{{ trans('merchantWorkdays.backend.table.saturday') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'sunday',
                        caption: '{{ trans('merchantWorkdays.backend.table.sunday') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'updated_at',
                        caption: '{{ trans('merchantWorkdays.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'created_at',
                        caption: '{{ trans('merchantWorkdays.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.merchant.merchantWorkdays.partials.table')
                ]
            });
        });
    </script>
