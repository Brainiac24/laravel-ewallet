...
@section('title', trans('merchantItems.backend.title'))
...
@section('content')
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['route' => ['admin.merchants.commission.items.store',$merchant_commission_id,null],'class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.merchant.merchantCommissionItem.partials.create_fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
