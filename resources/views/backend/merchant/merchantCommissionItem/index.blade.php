...
@section('content')
    ...
    @include('backend.merchant.merchantCommissionItem.partials.search_box')
    ...
    <div class="box box-solid">
        ...
        <div class="box-footer">
            {{  $merchantCommissionItems->render() }}
        </div>
    </div><!-- /.box -->
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                columns: [
                    ...
                    {
                        field: 'name',
                        caption: '{{ trans('merchantCommissionItem.backend.table.name') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'min',
                        caption: '{{ trans('merchantCommissionItem.backend.table.min') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'max',
                        caption: '{{ trans('merchantCommissionItem.backend.table.max') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'value',
                        caption: '{{ trans('merchantCommissionItem.backend.table.value') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'is_percentage',
                        caption: '{{ trans('merchantCommissionItem.backend.table.is_percentage') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        ...
                        caption: '{{ trans('merchantCommissionItem.backend.table.merchant_commission_id') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {{--{--}}
                        {{--field: 'is_active',--}}
                        {{--caption: '{{ trans('merchantCommissionItem.backend.table.is_active') }}',--}}
                        {{--size: '30%',--}}
                        {{--sortable: true,--}}
                        {{--attr: 'align=left'--}}
                    {{--},--}}
                    {
                        field: 'updated_at',
                        caption: '{{ trans('merchantCommissionItem.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                    {
                        field: 'created_at',
                        caption: '{{ trans('merchantCommissionItem.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.merchant.merchantCommissionItem.partials.table')
                ]
            });
        });
    </script>
