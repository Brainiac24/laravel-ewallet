...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($categoryRepository , ['route' => ['admin.categories.update', $categoryRepository->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.service.category.partials.fields')
            {!! Form::close() !!}
        </div><!-- /.box-body -->
