    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('bonusAccrualStatus.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('bonusAccrualStatus.backend.table.name') }}', type: 'text' },
                ],
                columns: [
                    {
                        field: 'recid',
                        ...
                        field: 'code',
                        caption: '{{ trans('bonusAccrualStatus.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{ trans('bonusAccrualStatus.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{ trans('bonusAccrualStatus.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('bonusAccrualStatus.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('bonusAccrualStatus.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.cashback.bonusAccrual.bonusAccrualStatus.partials.table')
                ]
            });
        });
    </script>
