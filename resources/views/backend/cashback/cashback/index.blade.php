    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    {field: 'name', caption: '{{ trans('cashback.backend.table.name') }}', type: 'text'}
                ],
                columns: [
                    {
                        field: 'recid',
                        ...
                        field: 'name',
                        caption: '{{ trans('cashback.backend.table.name') }}',
                        size: '75%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'start_date',
                        caption: '{{ trans('cashback.backend.table.start_date') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'end_date',
                        caption: '{{ trans('cashback.backend.table.end_date') }}',
                        size: '25%',
                        sortable: true,
                        attr: 'align=left'
                    {{--},{--}}
                        {{--field: 'is_popular',--}}
                        {{--caption: '{{ trans('cashback.backend.table.is_popular') }}',--}}
                        {{--size: '30%',--}}
                        {{--sortable: true,--}}
                        {{--attr: 'align=left'--}}
                    },{
                        field: 'is_active',
                        caption: '{{ trans('cashback.backend.table.is_active') }}',
                        size: '30%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('cashback.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    }, {
                        field: 'created_at',
                        caption: '{{ trans('cashback.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.cashback.cashback.partials.table')
                ]
            });
        });
    </script>
