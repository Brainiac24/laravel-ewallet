...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            {!! Form::model($data , ['route' => ['admin.cashbacks.update', $data->id], 'method' => 'patch','class'=>'form-horizontal','id'=>'form-category']) !!}
            @include('backend.cashback.cashback.partials.fields')
            {!! Form::close() !!}
