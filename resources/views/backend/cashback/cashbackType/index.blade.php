...
@section('content_header')
    <h1>{{ trans('cashbackType.backend.title') }}</h1>
@stop
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('cashbackType.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('cashbackType.backend.table.name') }}', type: 'text' },
                ],
                columns: [
                    {
                        field: 'recid',
                        ...
                        field: 'code',
                        caption: '{{ trans('cashbackType.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{ trans('cashbackType.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'is_active',
                        caption: '{{ trans('cashbackType.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('cashbackType.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('cashbackType.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.cashback.cashbackType.partials.table')
                ]
            });
        });
    </script>
