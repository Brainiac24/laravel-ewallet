    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#grid').w2grid({
                ...
                multiSearch: true,
                searches: [
                    { field: 'code', caption: '{{ trans('city.backend.table.code') }}', type: 'text' },
                    { field: 'name', caption: '{{ trans('city.backend.table.name') }}', type: 'text' },
                    { field: 'desc', caption: '{{ trans('city.backend.table.desc') }}', type: 'text' },
                ],
                columns: [
                    {
                        field: 'recid',
                        ...
                        field: 'code',
                        caption: '{{ trans('city.backend.table.code') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'code_map',
                        caption: '{{ trans('city.backend.table.code_map') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'name',
                        caption: '{{ trans('city.backend.table.name') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'desc',
                        caption: '{{ trans('city.backend.table.desc') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'area_id',
                        caption: '{{ trans('area.backend.table.title') }}',
                        size: '80%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'region_id',
                        caption: '{{ trans('region.backend.table.title') }}',
                        size: '80%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        ...
                        field: 'is_active',
                        caption: '{{ trans('city.backend.table.is_active') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'updated_at',
                        caption: '{{ trans('city.backend.table.updated_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },{
                        field: 'created_at',
                        caption: '{{ trans('city.backend.table.created_at') }}',
                        size: '50%',
                        sortable: true,
                        attr: 'align=left'
                    },
                ...
                records: [
                    @include('backend.city.partials.table')
                ]
            });
        });
    </script>
