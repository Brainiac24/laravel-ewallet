...
class GetCurrencyRateCategoryCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:get_currency_rate_esh_transfer';
     ...
     * @var string
     */
    protected $description = 'Get currency rates for transfers with queue callback';
        ...
        foreach ($currencies as $item) {
            try {
                $payload = [
                    ...
                    'type_rate' => CurrencyRateCategory::TRANSFER_CODE_MAP,
                ];
