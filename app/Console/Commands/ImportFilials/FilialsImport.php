...
class FilialsImport implements ToModel, WithBatchInserts
{
    public $head = true;
    ...
    public $filialsCount = 0;
    public $loadedFilialsCount = 0;
                    ...
                    if (is_numeric(trim($row[9])) && is_numeric(trim($row[10]))) {
                        ...
                        return new CoordinatePoint(
                            [
                                ...
                                'address' => str_replace(' /', ',', trim($row[2])),
                                'object_type' => 1, //банкоба
                            ]
                        );
                    }
                }
