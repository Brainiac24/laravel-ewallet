...
class TransactionMerchantContinueProcess extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'transaction_merchant:continue-process {transaction_id}';
    ...
    public function handle()
    {
        ...
        $transaction = $this->transactionRepository->findById($this->argument('transaction_id'));
        ...
        $i=0;
            ...
            try {
                ...
                $response = $client->request('POST', config('queue_transporter.queue_callback_url') , ['json' => ['merchant_transaction_id' =>  $transaction->id]]);
