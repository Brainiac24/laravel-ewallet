...
class AccountListImport implements ToModel, WithBatchInserts
{
    public $head = true;
    ...
    /**
     * @param array $row
     * @return AccountType|\Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Model[]|null
     * @throws \Exception
     */
