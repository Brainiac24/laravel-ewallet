...
namespace App\Http\Requests\Backend\Web\Order\OrderDepositType;


use Illuminate\Foundation\Http\FormRequest;

class UpdateOrderDepositTypeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'detail_params_html' => 'required|string',
