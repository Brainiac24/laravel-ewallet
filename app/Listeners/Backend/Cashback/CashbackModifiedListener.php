...
namespace App\Listeners\Backend\Cashback;
...
class CashbackModifiedListener
{
    ...
    {
        $merchantIds = Merchant::where('merchant_cashback_id', $event->entity->id)
            ->orWhere('bank_cashback_id', $event->entity->id)
            ->get()->pluck('id');
