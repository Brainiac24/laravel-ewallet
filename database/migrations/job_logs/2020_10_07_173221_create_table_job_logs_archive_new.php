...
class CreateTableJobLogsArchiveNew extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('job_logs_archive_new', function (Blueprint $table) {
            $table->uuid('id');
    ...
    {
        Schema::dropIfExists('job_logs_archive_new');
    }
}
