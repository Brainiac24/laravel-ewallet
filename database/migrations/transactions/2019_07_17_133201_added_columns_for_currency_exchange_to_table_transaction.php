...
class AddedColumnsForCurrencyExchangeToTableTransaction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('transactions', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `transactions` CHANGE `currency_rate_value` `currency_rate_value` decimal(11,4) DEFAULT 0.0000  NULL  AFTER `commission`");
