...
class LicenseAgreementSeeder extends Database\Seeds\BaseSeeder
{
    /**
...
';
        try {
            Storage::disk('LicenceAgreement')->put('LicenceAgreement.txt', $licenseText);
        } catch (\Exception $e) {
            $this->logger->error('LICENSE_ERROR'.$e->getMessage());
        }
